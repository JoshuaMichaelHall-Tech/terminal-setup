...
echo "==================================================================="
echo ""
echo "1. Restart your terminal or run 'source ~/.zshrc' to load new Zsh config"
echo "2. Run 'p10k configure' to set up the Powerlevel10k theme"
echo "3. Open Neovim and let it install plugins (it may show errors on first run)"
echo "4. In tmux, press Ctrl+a followed by 'I' to install tmux plugins"
echo "5. Your old configurations are backed up in: $BACKUP_DIR"
echo ""
